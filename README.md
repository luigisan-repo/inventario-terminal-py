...
Este repositorio contiene el proyecto final para el curso de **Iniciación a la Programación con Python** [TalentoTech](https://talentotech.bue.edu.ar/home#/trayectos/adultos).
...
El código está modularizado para separar la lógica del menú y la base de datos:
